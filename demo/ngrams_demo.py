...
ngram_model.fit(names_train, names_test, loss_type = loss_type)
...
print(f"\t\tMean perplexity of training set: {ngram_model.calculate_mean_perplexity(names_train):.2f}")
print(f"\t\tMean perplexity of test set: {ngram_model.calculate_mean_perplexity(names_test):.2f}\n")
...
ngram_nn.fit(train=names_train, test=names_test,learning_rate=50, epochs=1000, 
...
print(f"\t\tMean perplexity of training set: {ngram_nn.calculate_mean_perplexity(names_train):.2f}")
print(f"\t\tMean perplexity of test set: {ngram_nn.calculate_mean_perplexity(names_test):.2f}\n")
